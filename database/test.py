...
def generate_random_leader(name):
    ...
    names_without_input_name = [
        n for n in names if n != name
    ]  # remove the input name from the list of names
    number_of_preferred_co_leaders = random.randint(1, 3)
    preferred_co_leaders = random.sample(
        names_without_input_name, number_of_preferred_co_leaders
    )
    ...
    trip_leader.create_leader(
        ...
        reliability_score,
        0,
        preferred_co_leaders,
        overnight_role,
        mountain_biking_role,
        spelunking_role,
        watersports_role,
        surfing_role,
        sea_kayaking_role,
